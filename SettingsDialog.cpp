...
SettingsDialog::SettingsDialog(AbstractTimeServiceManager *manager, const QList<AbstractTimeServiceManager *> &availableManagers, QWidget *parent)
    : QDialog{parent},
      m_manager{manager},
...
QWidget *SettingsDialog::createBackendPage()
{
    ...
    connect(timeServices, &QComboBox::currentIndexChanged, timeServices, [this, timeServices](int i) {
        ...
        switch (QMessageBox::information(this, tr("Restart app to continue"), tr("To continue, the app will need to restart."), QMessageBox::Ok | QMessageBox::Cancel, QMessageBox::Ok))
        {
        case QMessageBox::Ok:
    ...
    connect(useNewApiKey, &QPushButton::clicked, this, [this, apiKeyInput](int) {
        if (QMessageBox::warning(this, tr("Restart required"), tr("To continue changing the API key, the program will restart."), QMessageBox::Ok | QMessageBox::Cancel) == QMessageBox::Ok)
        {
...
QWidget *SettingsDialog::createProjectPage()
{
	...
	connect(projectButtons, QOverload<QAbstractButton *>::of(&QButtonGroup::buttonClicked), projectButtons,
	...
	connect(breakProject, &QComboBox::currentIndexChanged, breakProject, [this, breakProject](int i) {
		...
		{
			QMessageBox::warning(this, tr("Invalid choice"), tr("You cannot set the same default project and break project!"));
	...
	connect(descriptionButtons, QOverload<QAbstractButton *>::of(&QButtonGroup::buttonClicked), descriptionButtons,
	        [descriptionButtons, useSpecificDescriptionBtn, defaultDescriptionEdit, useLastDescriptionBtn, useNoDescriptionBtn](QAbstractButton *) {
