...
public:
	explicit TimeEntry(const QString &id, const Project &project, const QString &description, const QString &userId, const QDateTime &start, const QDateTime &end, QObject *parent = nullptr);
