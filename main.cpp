...
int main(int argc, char *argv[])
{
	...
	do
	{
		...
		if (oldSettings.contains(QStringLiteral("apiKey")))
		{
			...
			settings.setValue(QStringLiteral("com.clockify/disableDescription"), oldSettings.value(QStringLiteral("disableDescription")));
			settings.setValue(QStringLiteral("com.clockify/projectId"), oldSettings.value(QStringLiteral("projectId")));
			settings.setValue(QStringLiteral("com.clockify/useLastDescription"), oldSettings.value(QStringLiteral("useLastDescription")));
			settings.setValue(QStringLiteral("com.clockify/useLastProject"), oldSettings.value(QStringLiteral("useLastProject")));
